...
const Header = () => {
    return (
        <header className="border-b border-gray-700 shadow min-h-20 flex gap-1 items-center px-5 lg:px-10">
            <h1 className="font-semibold grow flex items-center justify-between text-sm sm:text-lg md:text-xl">
                ...
                <a href={REPO_URL} target="_blank" className="group relative">
                    ...
                    <span className="rounded-lg text-gray-200 bg-gray-800 px-2.5 shadow py-1 -translate-x-[10%] absolute truncate -left-20 translate-y-0 scale-y-0 group-hover:scale-y-100 group-focus:scale-y-100 group-hover:translate-y-1 sm:-translate-x-[30%] group-focus:-translate-x-[30%] delay-500 transition-all ease-in-out">{'View on GitHub'}</span>
                </a>
            </h1>
        </header>
    )
